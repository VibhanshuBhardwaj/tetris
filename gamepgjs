...
var _user$project$Tetromino$zeroToOne = A2(_elm_lang$core$Random$float, 0, 1);
var _user$project$Tetromino$shift = F2(
	function (_p0, tetromino) {
		var _p1 = _p0;
		var _p5 = _p1._0;
		var _p4 = _p1._1;
		var newPivot = {
			r: tetromino.pivot.r + _elm_lang$core$Basics$toFloat(_p5),
			c: tetromino.pivot.c + _elm_lang$core$Basics$toFloat(_p4)
		};
		var shiftLocation = function (_p2) {
			var _p3 = _p2;
			return {ctor: '_Tuple2', _0: _p3._0 + _p5, _1: _p3._1 + _p4};
		};
		var newShape = A2(_elm_lang$core$List$map, shiftLocation, tetromino.shape);
		return _elm_lang$core$Native_Utils.update(
			tetromino,
			{shape: newShape, pivot: newPivot});
	});
var _user$project$Tetromino$rotateLocation = F3(
	function (pivot, angle, _p6) {
		var _p7 = _p6;
		var _p8 = {
			ctor: '_Tuple2',
		...
		var s = _p8._0;
		var c = _p8._1;
		var original_c = _elm_lang$core$Basics$toFloat(_p7._1) - pivot.c;
		var original_r = _elm_lang$core$Basics$toFloat(_p7._0) - pivot.r;
		var new_r = (original_r * c) - (original_c * s);
		var new_c = (original_r * s) + (original_c * c);
		return {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Basics$round(new_r + pivot.r),
			_1: _elm_lang$core$Basics$round(new_c + pivot.c)
		};
	});
var _user$project$Tetromino$rotateTetromino = function (tetromino) {
	var specificRotationLocation = A2(
		_user$project$Tetromino$rotateLocation,
		tetromino.pivot,
		_elm_lang$core$Basics$degrees(90));
	var newShape = A2(_elm_lang$core$List$map, specificRotationLocation, tetromino.shape);
	return _elm_lang$core$Native_Utils.update(
		tetromino,
		{shape: newShape, rows: tetromino.cols, cols: tetromino.rows});
};
var _user$project$Tetromino$drawPivot = function (_p9) {
	var _p10 = _p9;
	var _p11 = _p10.pivot;
	var translate = _evancz$elm_graphics$Collage$move(
		{ctor: '_Tuple2', _0: _p11.c * _user$project$Block$size, _1: _p11.r * _user$project$Block$size});
	var piv = A2(
		_evancz$elm_graphics$Collage$filled,
		_elm_lang$core$Color$red,
		_evancz$elm_graphics$Collage$circle(5));
	return translate(piv);
};
var _user$project$Tetromino$o = {
	shape: {
		ctor: '::',
	...
	block: _user$project$Block$Block(_elm_lang$core$Color$yellow),
	pivot: {r: -0.5, c: 0.5},
	rows: 2,
	cols: 3
};
var _user$project$Tetromino$t = {
	shape: {
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 0, _1: -1},
		_1: {
	...
	block: _user$project$Block$Block(_elm_lang$core$Color$purple),
	pivot: {r: 0.0, c: 0.0},
	rows: 2,
	cols: 3
};
var _user$project$Tetromino$tetro = A2(
	_user$project$Tetromino$shift,
	{ctor: '_Tuple2', _0: -9, _1: 2},
	_user$project$Tetromino$rotateTetromino(_user$project$Tetromino$t));
var _user$project$Tetromino$s = {
	shape: {
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 0, _1: 0},
		_1: {
	...
	block: _user$project$Block$Block(_elm_lang$core$Color$green),
	pivot: {r: 0.0, c: 0.0},
	rows: 2,
	cols: 3
};
var _user$project$Tetromino$z = {
	shape: {
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 1, _1: -1},
		_1: {
	...
	block: _user$project$Block$Block(_elm_lang$core$Color$red),
	pivot: {r: 0.0, c: 0.0},
	rows: 2,
	cols: 3
};
var _user$project$Tetromino$l = {
	shape: {
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 1, _1: 0},
		_1: {
	...
	block: _user$project$Block$Block(_elm_lang$core$Color$orange),
	pivot: {r: 0.0, c: 0.0},
	rows: 3,
	cols: 2
};
var _user$project$Tetromino$j = {
	...
	block: _user$project$Block$Block(_elm_lang$core$Color$blue),
	pivot: {r: 0.0, c: 0.0},
	rows: 3,
	cols: 2
};
var _user$project$Tetromino$i = {
	...
	block: _user$project$Block$Block(_elm_lang$core$Color$lightBlue),
	pivot: {r: -0.5, c: 0.5},
	rows: 4,
	cols: 1
};
var _user$project$Tetromino$shuffleBag = function (weights) {
	var tetrominos = {
		ctor: '::',
		_0: _user$project$Tetromino$i,
		_1: {
			ctor: '::',
			_0: _user$project$Tetromino$o,
			_1: {
				ctor: '::',
				_0: _user$project$Tetromino$j,
				_1: {
					ctor: '::',
					_0: _user$project$Tetromino$l,
					_1: {
						ctor: '::',
						_0: _user$project$Tetromino$z,
						_1: {
							ctor: '::',
							_0: _user$project$Tetromino$s,
							_1: {
								ctor: '::',
								_0: _user$project$Tetromino$t,
								_1: {ctor: '[]'}
							}
						}
					}
	...
	var weighted = A3(
		...
		weights,
		tetrominos);
	var sorted = A2(_elm_lang$core$List$sortBy, _elm_lang$core$Tuple$first, weighted);
	return A2(_elm_lang$core$List$map, _elm_lang$core$Tuple$second, sorted);
};
var _user$project$Tetromino$bag = function () {
	var weights = A2(_elm_lang$core$Random$list, 7, _user$project$Tetromino$zeroToOne);
	return A2(_elm_lang$core$Random$map, _user$project$Tetromino$shuffleBag, weights);
}();
var _user$project$Tetromino$toForm = function (_p12) {
	var _p13 = _p12;
	var form = _user$project$Block$toForm(_p13.block);
	var translate = function (_p14) {
		...
		return A2(
			...
			{
				ctor: '_Tuple2',
				_0: _elm_lang$core$Basics$toFloat(_p15._1) * _user$project$Block$size,
				_1: _elm_lang$core$Basics$toFloat(_p15._0) * _user$project$Block$size
			},
			form);
	};
	var forms = A2(_elm_lang$core$List$map, translate, _p13.shape);
...
var _user$project$Tetromino$main = _elm_lang$virtual_dom$Native_VirtualDom.staticProgram(
	_evancz$elm_graphics$Element$toHtml(
		A3(
			...
			{
				ctor: '::',
				_0: _user$project$Tetromino$toForm(_user$project$Tetromino$tetro),
				_1: {
					ctor: '::',
					_0: _user$project$Tetromino$drawPivot(_user$project$Tetromino$tetro),
					_1: {ctor: '[]'}
				}
			})));
...
var _user$project$Board$isIntersecting = F2(
	function (_p0, board) {
		var _p1 = _p0;
		var checkLocation = function (location) {
			return A2(_elm_lang$core$Dict$member, location, board);
		};
		return A2(_elm_lang$core$List$any, checkLocation, _p1.shape);
	});
var _user$project$Board$clearRow = F2(
	function (row, board) {
		var shift = F3(
			function (_p2, block, newBoard) {
				var _p3 = _p2;
				var _p5 = _p3._0;
				var _p4 = _p3._1;
				return (_elm_lang$core$Native_Utils.cmp(_p5, row) < 0) ? A3(
					_elm_lang$core$Dict$insert,
					{ctor: '_Tuple2', _0: _p5, _1: _p4},
					block,
					newBoard) : ((_elm_lang$core$Native_Utils.cmp(_p5, row) > 0) ? A3(
					_elm_lang$core$Dict$insert,
					{ctor: '_Tuple2', _0: _p5 - 1, _1: _p4},
					block,
					newBoard) : newBoard);
			});
		return A3(_elm_lang$core$Dict$foldr, shift, _elm_lang$core$Dict$empty, board);
	});
var _user$project$Board$tetromino = A2(
	_user$project$Tetromino$shift,
	{ctor: '_Tuple2', _0: 0, _1: 5},
	_user$project$Tetromino$j);
var _user$project$Board$cumSum = A2(
	...
	0);
var _user$project$Board$iota = function (n) {
	return _user$project$Board$cumSum(
		A2(_elm_lang$core$List$repeat, n - 1, 1));
};
var _user$project$Board$rows = 20;
var _user$project$Board$cols = 10;
var _user$project$Board$background = function () {
	var shape = A2(
		_evancz$elm_graphics$Collage$rect,
		_elm_lang$core$Basics$toFloat(_user$project$Board$cols) * _user$project$Block$size,
		_elm_lang$core$Basics$toFloat(_user$project$Board$rows) * _user$project$Block$size);
	return A2(_evancz$elm_graphics$Collage$filled, _elm_lang$core$Color$black, shape);
}();
var _user$project$Board$addBlock = F3(
	function (_p6, block, form) {
		var _p7 = _p6;
		var y = _elm_lang$core$Basics$toFloat(_p7._0) * _user$project$Block$size;
		var x = _elm_lang$core$Basics$toFloat(_p7._1) * _user$project$Block$size;
		var offSetY = ((0 - _elm_lang$core$Basics$toFloat(_user$project$Board$rows - 1)) / 2) * _user$project$Block$size;
		var offSetX = ((0 - _elm_lang$core$Basics$toFloat(_user$project$Board$cols - 1)) / 2) * _user$project$Block$size;
		var blockForm = A2(
			_evancz$elm_graphics$Collage$move,
			{ctor: '_Tuple2', _0: x + offSetX, _1: y + offSetY},
			_user$project$Block$toForm(block));
		return _evancz$elm_graphics$Collage$group(
			{
				ctor: '::',
				_0: form,
...
var _user$project$Board$toForm = function (board) {
	return A3(_elm_lang$core$Dict$foldr, _user$project$Board$addBlock, _user$project$Board$background, board);
};
var _user$project$Board$testForm = A3(
	_user$project$Board$addBlock,
	{ctor: '_Tuple2', _0: 0, _1: 0},
	_user$project$Block$Block(_elm_lang$core$Color$blue),
	_user$project$Board$background);
var _user$project$Board$checkRow = F2(
	function (row, board) {
		var blocks = A2(
			_elm_lang$core$Dict$filter,
			F2(
				function (_p9, _p8) {
					var _p10 = _p9;
					return _elm_lang$core$Native_Utils.eq(_p10._0, row);
				}),
			board);
		return _elm_lang$core$Native_Utils.eq(
			_elm_lang$core$Dict$size(blocks),
			_user$project$Board$cols);
	});
var _user$project$Board$clearLines = function () {
	var clearRec = F3(
		function (row, lines, board) {
			clearRec:
			while (true) {
				if (_elm_lang$core$Native_Utils.cmp(row, _user$project$Board$rows) > 0) {
					return {ctor: '_Tuple2', _0: lines, _1: board};
				} else {
					if (A2(_user$project$Board$checkRow, row, board)) {
						var _v4 = row,
							_v5 = lines + 1,
							_v6 = A2(_user$project$Board$clearRow, row, board);
						row = _v4;
						lines = _v5;
						board = _v6;
						continue clearRec;
	...
	return A2(clearRec, 0, 0);
}();
var _user$project$Board$inBounds = function (_p11) {
	var _p12 = _p11;
	var checkLocation = function (_p13) {
		var _p14 = _p13;
		var _p15 = _p14._1;
		return (_elm_lang$core$Native_Utils.cmp(_p14._0, 0) > -1) && ((_elm_lang$core$Native_Utils.cmp(_p15, 0) > -1) && (_elm_lang$core$Native_Utils.cmp(_p15, _user$project$Board$cols) < 0));
	};
	return A2(_elm_lang$core$List$all, checkLocation, _p12.shape);
};
var _user$project$Board$isValid = F2(
	function (tetro, board) {
		return _user$project$Board$inBounds(tetro) && (!A2(_user$project$Board$isIntersecting, tetro, board));
	});
var _user$project$Board$new = _elm_lang$core$Dict$fromList;
var _user$project$Board$fillRow = F3(
	function (row, block, board) {
		var blocks = A2(_elm_lang$core$List$repeat, _user$project$Board$cols, block);
		var rows = A2(_elm_lang$core$List$repeat, _user$project$Board$cols, row);
		var columns = _user$project$Board$iota(_user$project$Board$cols);
		var locations = A3(
			_elm_lang$core$List$map2,
			F2(
				function (v0, v1) {
			...
			rows,
			columns);
		var filledRow = _user$project$Board$new(
			A3(
				_elm_lang$core$List$map2,
				F2(
					function (v0, v1) {
				...
				locations,
				blocks));
		return A2(_elm_lang$core$Dict$union, filledRow, board);
	});
var _user$project$Board$addTetromino = F2(
	function (_p16, board) {
		var _p17 = _p16;
		var asBoard = _user$project$Board$new(
			A3(
				_elm_lang$core$List$map2,
				F2(
					function (v0, v1) {
				...
				_p17.shape,
				A2(_elm_lang$core$List$repeat, 4, _p17.block)));
		return A2(_elm_lang$core$Dict$union, asBoard, board);
	});
var _user$project$Board$testBoard = _user$project$Board$new(
	{
		ctor: '::',
		_0: {
			ctor: '_Tuple2',
			_0: {ctor: '_Tuple2', _0: 0, _1: 0},
			_1: _user$project$Block$Block(_elm_lang$core$Color$blue)
		},
		_1: {
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: {ctor: '_Tuple2', _0: 0, _1: 1},
				_1: _user$project$Block$Block(_elm_lang$core$Color$yellow)
			},
			_1: {ctor: '[]'}
		}
	});
var _user$project$Board$test = _user$project$Board$new(
	{ctor: '[]'});
		...
		A2(
			...
			_evancz$elm_graphics$Element$down,
			{
				...
				_0: A3(
					...
					{
						ctor: '::',
						_0: _user$project$Board$toForm(
							A2(_user$project$Board$addTetromino, _user$project$Board$tetromino, _user$project$Board$test)),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: _evancz$elm_graphics$Element$show(
						A2(_user$project$Board$isValid, _user$project$Board$tetromino, _user$project$Board$test)),
					_1: {ctor: '[]'}
				}
			})));

var _user$project$Game$arrowsToInput = F2(
	function (keyCode, t) {
		return _elm_lang$core$Native_Utils.eq(keyCode, 38) ? _user$project$Tetromino$rotateTetromino(t) : (_elm_lang$core$Native_Utils.eq(keyCode, 40) ? A2(
			_user$project$Tetromino$shift,
			{ctor: '_Tuple2', _0: -1, _1: 0},
			t) : (_elm_lang$core$Native_Utils.eq(keyCode, 37) ? A2(
			_user$project$Tetromino$shift,
			{ctor: '_Tuple2', _0: 0, _1: -1},
			t) : (_elm_lang$core$Native_Utils.eq(keyCode, 39) ? A2(
			_user$project$Tetromino$shift,
			{ctor: '_Tuple2', _0: 0, _1: 1},
			t) : A2(
			_user$project$Tetromino$shift,
...
var _user$project$Game$useIfValid = F2(
	function (curr, $new) {
		return A2(_user$project$Board$isValid, $new.falling, $new.board) ? $new : curr;
	});
var _user$project$Game$tryKicks = F3(
	function (shifts, curr, next) {
		tryKicks:
		while (true) {
			var _p0 = shifts;
			if (_p0.ctor === '[]') {
				...
				var shifted = A2(_user$project$Tetromino$shift, _p0._0, next.falling);
				if (A2(_user$project$Board$isValid, shifted, next.board)) {
					return _elm_lang$core$Native_Utils.update(
						next,
						{falling: shifted});
				} else {
...
var _user$project$Game$wallKick = F2(
	function (curr, next) {
		var range = (next.falling.cols / 2) | 0;
		var shifts = A2(
			_elm_lang$core$List$concatMap,
			function (n) {
				return {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 0, _1: n},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 0, _1: 0 - n},
						_1: {ctor: '[]'}
					}
				};
			},
			A2(_elm_lang$core$List$range, 1, range));
		return A3(_user$project$Game$tryKicks, shifts, curr, next);
	});
var _user$project$Game$floorKick = F2(
	function (curr, next) {
		var range = (next.falling.rows / 2) | 0;
		var shifts = A2(
			_elm_lang$core$List$map,
			function (n) {
...
var _user$project$Game$checkBag = function (state) {
	if (!_elm_lang$core$List$isEmpty(state.bag)) {
		return state;
	} else {
		var _p1 = A2(_elm_lang$core$Random$step, _user$project$Tetromino$bag, state.seed);
		var bag = _p1._0;
		var seed = _p1._1;
		return _elm_lang$core$Native_Utils.update(
			state,
...
var _user$project$Game$isGameOver = function (model) {
	var checkIfOver = function (_p2) {
		var _p3 = _p2;
		return _elm_lang$core$Native_Utils.cmp(_p3._0, 20) > -1;
	};
	return A2(
		_elm_lang$core$List$any,
		checkIfOver,
		_elm_lang$core$Dict$keys(model.board));
};
var _user$project$Game$view = function (model) {
	var messageToDisplay = _user$project$Game$isGameOver(model) ? A2(
		_elm_lang$core$Basics_ops['++'],
		'Game over! Your score was ',
		A2(
			_elm_lang$core$Basics_ops['++'],
			_elm_lang$core$Basics$toString(model.score),
			'. Press R to restart')) : A2(
		_elm_lang$core$Basics_ops['++'],
		'Current score: ',
		A2(
			_elm_lang$core$Basics_ops['++'],
	...
	var title = _evancz$elm_graphics$Element$show('Quatris | Use arrow keys to move the falling pieces. The up arrow rotates the falling piece.');
	...
	var elem = A2(
		...
		_evancz$elm_graphics$Element$down,
		{
			...
			_1: {
				ctor: '::',
				_0: _evancz$elm_graphics$Element$show(messageToDisplay),
				_1: {ctor: '[]'}
			}
		});
	var completeElem = A2(
	...
	return _evancz$elm_graphics$Element$toHtml(completeElem);
};
var _user$project$Game$startingShift = {ctor: '_Tuple2', _0: 20, _1: 5};
var _user$project$Game$nextTetromino = function (model) {
	var state = _user$project$Game$checkBag(model);
	var nextFalling = A2(
		_user$project$Tetromino$shift,
		_user$project$Game$startingShift,
		A2(
			_elm_lang$core$Maybe$withDefault,
			_user$project$Tetromino$o,
			_elm_lang$core$List$head(state.bag)));
	var nextBag = A2(_elm_lang$core$List$drop, 1, state.bag);
	var _p4 = _user$project$Board$clearLines(
		A2(_user$project$Board$addTetromino, state.falling, state.board));
	var lines = _p4._0;
	var nextBoard = _p4._1;
	var bonusScore = _elm_lang$core$Native_Utils.eq(lines, 1) ? 1 : (lines * 5);
	return _elm_lang$core$Native_Utils.update(
		state,
		{falling: nextFalling, bag: nextBag, board: nextBoard, score: state.score + bonusScore});
};
var _user$project$Game$initialSeed = 69;
var _user$project$Game$defaultModel = function () {
	var initSeed = _elm_lang$core$Random$initialSeed(_user$project$Game$initialSeed);
	var bag = _elm_lang$core$Tuple$first(
		A2(_elm_lang$core$Random$step, _user$project$Tetromino$bag, initSeed));
	var falling = A2(
		_elm_lang$core$Maybe$withDefault,
		_user$project$Tetromino$j,
		_elm_lang$core$List$head(bag));
	var newBag = A2(_elm_lang$core$List$drop, 1, bag);
	var seed = _elm_lang$core$Tuple$second(
		A2(_elm_lang$core$Random$step, _user$project$Tetromino$bag, initSeed));
	return {
		falling: A2(_user$project$Tetromino$shift, _user$project$Game$startingShift, falling),
		seed: seed,
		bag: newBag,
		board: _user$project$Board$new(
			{ctor: '[]'}),
		score: 0,
		difficulty: _elm_lang$core$Time$second
	};
}();
var _user$project$Game$init = {ctor: '_Tuple2', _0: _user$project$Game$defaultModel, _1: _elm_lang$core$Platform_Cmd$none};
var _user$project$Game$update = F2(
	function (msg, model) {
		var isUpdateValid = _user$project$Game$useIfValid(model);
		var _p5 = msg;
		if (_p5.ctor === 'KeyMsg') {
			var _p6 = _p5._0;
			var rotated = _elm_lang$core$Native_Utils.update(
				model,
				{
					falling: _user$project$Tetromino$rotateTetromino(model.falling)
				});
			var nextState = isUpdateValid(rotated);
			var newModel = _elm_lang$core$Native_Utils.eq(nextState, model) ? A2(_user$project$Game$wallKick, model, rotated) : nextState;
			var newNewModel = _elm_lang$core$Native_Utils.eq(newModel, model) ? A2(_user$project$Game$floorKick, model, rotated) : newModel;
			var newFalling = A2(_user$project$Game$arrowsToInput, _p6, model.falling);
			var normalShift = isUpdateValid(
				_elm_lang$core$Native_Utils.update(
					model,
					{falling: newFalling}));
			var correctMove = _elm_lang$core$Native_Utils.eq(_p6, 38) ? {ctor: '_Tuple2', _0: newNewModel, _1: _elm_lang$core$Platform_Cmd$none} : (_elm_lang$core$Native_Utils.eq(_p6, 82) ? {ctor: '_Tuple2', _0: _user$project$Game$defaultModel, _1: _elm_lang$core$Platform_Cmd$none} : (_elm_lang$core$Native_Utils.eq(_p6, 68) ? {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{difficulty: _elm_lang$core$Time$millisecond * 100}),
				_1: _elm_lang$core$Platform_Cmd$none
			} : {ctor: '_Tuple2', _0: normalShift, _1: _elm_lang$core$Platform_Cmd$none}));
			return correctMove;
		} else {
			var newFalling = A2(
				_user$project$Tetromino$shift,
				{ctor: '_Tuple2', _0: -1, _1: 0},
				model.falling);
			var isValid = A2(_user$project$Board$isValid, newFalling, model.board);
			var newModel = isValid ? _elm_lang$core$Native_Utils.update(
				model,
				{falling: newFalling}) : (_user$project$Game$isGameOver(model) ? _elm_lang$core$Native_Utils.update(
				_user$project$Game$defaultModel,
				{score: model.score}) : _user$project$Game$nextTetromino(model));
			return {ctor: '_Tuple2', _0: newModel, _1: _elm_lang$core$Platform_Cmd$none};
		}
	});
var _user$project$Game$Model = F6(
	function (a, b, c, d, e, f) {
		return {falling: a, board: b, seed: c, bag: d, score: e, difficulty: f};
	});
var _user$project$Game$Shift = function (a) {
	return {ctor: 'Shift', _0: a};
};
var _user$project$Game$Rotate = {ctor: 'Rotate'};
var _user$project$Game$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _user$project$Game$KeyMsg = function (a) {
	return {ctor: 'KeyMsg', _0: a};
};
var _user$project$Game$subscriptions = function (model) {
	return (!_user$project$Game$isGameOver(model)) ? _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: A2(_elm_lang$core$Time$every, model.difficulty, _user$project$Game$Tick),
			_1: {
				ctor: '::',
				_0: _elm_lang$keyboard$Keyboard$downs(_user$project$Game$KeyMsg),
				_1: {ctor: '[]'}
			}
		}) : _elm_lang$keyboard$Keyboard$downs(_user$project$Game$KeyMsg);
};
